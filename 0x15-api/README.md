# API
This project served as additional hands-on experience in working with APIs.
I gathered data from the JSONPlaceholder REST API and acquired proficiency in
exporting it to either CSV or JSON formats.
